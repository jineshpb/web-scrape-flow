...
function ExecutionsTableComponent({
  workflowId,
  initialData,
}: {
  workflowId: string;
  ...
  return (
    <div className="border rounded-lg border-separate shadow-md overflow-auto">
          ...
          {query.data?.map((execution) => {
            ...
            return (
              ...
              >
                ...
                <TableCell className="text-righttext-muted-foreground">
                  {formattedStartedAt}
                </TableCell>
              </TableRow>
            );
...
export default ExecutionsTableComponent;

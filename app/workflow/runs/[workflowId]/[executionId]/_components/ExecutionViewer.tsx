...
function ParameterViewer({
  ...
  return (
    <Card className="bg-primary-foreground dark:bg-foreground/10">
...
function LogsViewer({ logs }: { logs: ExecutionLog[] | undefined }) {
  ...
  return (
    <Card className="w-full">
      <CardHeader className="rounded-lg rounded-b-none border-b py-4 bg-primary-foreground  dark:bg-foreground/10">
        <CardTitle className="text-base">Logs</CardTitle>
        <CardDescription className="text-muted-foreground text-sm">
          Logs generated by this phase
        </CardDescription>
      </CardHeader>
      <CardContent className="p-0 w-full bg-primary-foreground dark:bg-foreground/10 ">
        <Table>
